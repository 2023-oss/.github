...
The custom sign service is a DID based personal information submission system that utilizes SSI(Self-Signature Identifier) which is managed by users with sovereignty over personal information And we also uses PlateChain, the open-source public blockchain we made..
